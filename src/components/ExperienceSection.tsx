...
const entries = [
  { type: 'work' as const, title: 'Full Stack Developer Intern (Remote)', org: 'Hostelbird', date: 'Jan 2026 — Present', points: ['Building and maintaining full-stack features using React, Node.js, and databases', 'Collaborating with the team on product development and UI/UX improvements', 'Working with REST APIs and integrating third-party services'] },
  { type: 'work' as const, title: 'Full Stack Intern (Remote)', org: 'Cofnigyz Technologies', date: 'May 2024 — Jun 2024', points: ['Gained hands-on experience with full-stack web development', 'Worked on real-world tasks involving data analysis and visualization', 'Strengthened skills in Python and data-driven problem solving'] },
  { type: 'education' as const, title: 'B.Tech in Computer Science Engineering', org: 'Islamic University of Science and Technology, Awantipora', date: '2023 — 2026', points: ['Specializing in software development and data science', 'Building full-stack projects and ML models during coursework', 'Strong foundation in algorithms, data structures, and system design'] },
  { type: 'education' as const, title: 'Diploma in Computer Science Engineering', org: 'Kashmir Government Polytechnic College, Srinagar', date: '2019 — 2022', points: ['Built a strong foundation in programming and computer fundamentals', 'Completed hands-on labs in networking, databases, and web technologies', 'Developed early interest in software development and problem solving'] },
];
