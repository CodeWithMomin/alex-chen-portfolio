...
const entries = [
  { type: 'work' as const, title: 'Full Stack Developer (Intern)', org: 'HostelBird', date: 'Present — Remote', points: ['Integrated and managed REST APIs for admin panel enabling dynamic content management', 'Implemented Jodit Editor for blog creation and redesigned booking flow UI', 'Developed analytics dashboard using Google Analytics and built affiliate program system', 'Contributed to Volunteer Yatra module and performed bug fixing & performance optimization'] },
  { type: 'work' as const, title: 'MERN Stack Developer (Intern)', org: 'Cognifyz Technologies', date: '2025 — Remote', points: ['Built a strong foundation in full-stack development using the MERN stack', 'Worked on frontend and backend tasks, API integration, and debugging', 'Learned to build real-world applications with modern web technologies'] },
  { type: 'education' as const, title: 'B.Tech in Computer Science Engineering', org: 'Islamic University of Science and Technology, Pulwama', date: '2023 — Jun 2026', points: ['Specializing in software development and data science', 'Building full-stack projects and ML models during coursework', 'Strong foundation in algorithms, data structures, and system design'] },
  { type: 'education' as const, title: 'Diploma in Information Technology', org: 'Kashmir Government Polytechnic, Srinagar', date: '2019 — Aug 2022', points: ['Built a strong foundation in programming and computer fundamentals', 'Completed hands-on labs in networking, databases, and web technologies', 'Developed early interest in software development and problem solving'] },
];
